...
using System.Data;
using MyRepository = Inventory.Common.Repositories.UserPreferenceRepository;
using MyRow = Inventory.Common.Entities.UserPreferenceRow;

namespace Inventory.Common.Endpoints
{
