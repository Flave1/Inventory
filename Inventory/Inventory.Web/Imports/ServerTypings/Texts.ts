    ...
    declare namespace Db {
        ...
        namespace Inventory {
            ...
            namespace OrderItems {
                ...
                export const OrderOrderDecription: string;
                export const OrderTotal: string;
            ...
            namespace Orders {
                export const CustomerDisplayName: string;
                ...
                export const CustomerLastDirectoryUpdate: string;
                export const CustomerSource: string;
                export const CustomerUpdateDate: string;
                export const CustomerUpdateUserId: string;
                export const CustomerUserImage: string;
                export const CustomerUserType: string;
                export const CustomerUsername: string;
                export const OrderDate: string;
                export const OrderDecription: string;
                export const OrderId: string;
                export const OrderItems: string;
                export const Status: string;
                export const StatusFailedDescription: string;
                export const StatusName: string;
            ...
            namespace Product {
                ...
                export const SupplierSupplierType: string;
                export const SupplierUserId: string;
                export const UnitPrice: string;
            }
            ...
            namespace Supplier {
                ...
                export const SupplierId: string;
                export const SupplierType: string;
                ...
                export const UserUserType: string;
