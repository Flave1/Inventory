...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Inventory
        {
            ...
            {
                public const string FulfillmentStatusIndex = "~/Modules/Inventory/FulfillmentStatus/FulfillmentStatusIndex.cshtml";
            }

            public static class OrderItems
            {
                public const string OrderItemsIndex = "~/Modules/Inventory/OrderItems/OrderItemsIndex.cshtml";
            }

            public static class Orders
            {
                public const string OrdersIndex = "~/Modules/Inventory/Orders/OrdersIndex.cshtml";
            }
            ...
            {
                public const string UserTypeIndex = "~/Modules/Inventory/UserType/UserTypeIndex.cshtml";
            }
